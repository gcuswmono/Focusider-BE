package mono.focusider.application.controller;
...
import mono.focusider.domain.auth.dto.SignupRequestDto;
import mono.focusider.domain.auth.dto.UsernameAvailabilityResponseDto;
import mono.focusider.domain.auth.service.AuthenticationService;
...
public class AuthController {
        ...
        public ResponseEntity<?> login(@RequestBody LoginRequestDto loginRequest, HttpServletResponse response) {
                AuthResponseDto authResponseDto = authenticationService.authenticate(loginRequest.getUsername(),
        ...
        public ResponseEntity<?> refreshToken(@CookieValue(name = "refresh_token") String refreshToken,
                ...
                AuthResponseDto authResponseDto = authenticationService.refreshToken(refreshToken);
