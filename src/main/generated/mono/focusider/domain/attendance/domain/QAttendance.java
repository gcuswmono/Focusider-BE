...
public class QAttendance extends EntityPathBase<Attendance> {
    ...
    private static final long serialVersionUID = 1769960639L;
    ...
    public QAttendance(Class<? extends Attendance> type, PathMetadata metadata, PathInits inits) {
        ...
        this.member = inits.isInitialized("member") ? new mono.focusider.domain.member.domain.QMember(forProperty("member")) : null;
    }
