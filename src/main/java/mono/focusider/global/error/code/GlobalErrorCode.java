...
public enum GlobalErrorCode implements ErrorCode {
    ...
    INVALID_FILE_DELETE(HttpStatus.BAD_REQUEST, "파일 삭제에 실패했습니다."),
     ...
     */
    PAYLOAD_TOO_LARGE(HttpStatus.PAYLOAD_TOO_LARGE, "전송된 파일의 크기가 너무 큽니다."),


    /**
     * 415 UNSUPPORTED_MEDIA_TYPE
     */
    UNSUPPORTED_MEDIA_TYPE(HttpStatus.UNSUPPORTED_MEDIA_TYPE, "지원하지 않는 Media 형식입니다."),
